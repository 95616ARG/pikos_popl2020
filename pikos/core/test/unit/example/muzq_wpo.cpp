#define BOOST_TEST_MODULE test_muzq_wpo
...
#include <ikos/core/example/muzq_wpo.hpp>
...
BOOST_AUTO_TEST_CASE(test1) {
  ...
  unsigned iterations[6] = {1,4,1,4,1,4};
  int idx = 0;
  int sum_a = 0;
  int sum_b = 0;
  for (auto bb : cfg) {
    sum_a += fixpoint.iteration(bb);
    sum_b += iterations[idx];
    idx++;
  }
  std::cerr << sum_a << "  " << sum_b << std::endl;
  BOOST_CHECK(sum_a == sum_b);
...
BOOST_AUTO_TEST_CASE(test3) {
  ...
  unsigned iterations[11] = {1,4,1,4,4,4,1,1,4,4,1};
  int idx = 0;
  int sum_a = 0;
  int sum_b = 0;
  for (auto bb : cfg) {
...
BOOST_AUTO_TEST_CASE(test4) {
  ...
  unsigned iterations[6] = {1,3,1,3,1,3};
  int idx = 0;
  int sum_a = 0;
  int sum_b = 0;
  for (auto bb : cfg) {
...
BOOST_AUTO_TEST_CASE(test5) {
  ...
  unsigned iterations[9] = {1,3,3,3,1,1,3,1,1};
  int idx = 0;
  int sum_a = 0;
  int sum_b = 0;
  for (auto bb : cfg) {
...
BOOST_AUTO_TEST_CASE(test6) {
  ...
  unsigned iterations[17] = {1,1,4,4,64,1,1,4,64,4,16,64,4,16,16,16,16};
  int idx = 0;
  int sum_a = 0;
  int sum_b = 0;
  for (auto bb : cfg) {
